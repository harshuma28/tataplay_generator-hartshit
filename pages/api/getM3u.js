...
const getAllChans = async () => {
    ...
    await fetch("https://ts-api.videoready.tv/content-detail/pub/api/v1/channels?limit=1000", requestOptions)
...
while (chanIds.length > 0) {
    ...
    await fetch("https://gist.githubusercontent.com/harshuma28/b8746927189cc280f8d445fa9e33a120/raw/3d7dfa7e3733a3c109c8a127abbcb8c7cab9f9c3/fetcher.json")
            ...
            if (chansList.length > 0) {
              ...
              m3uStr = '#EXTM3U x-tvg-url="https://www.tsepg.cf/epg.xml.gz"\n\n';
                ...
                for (let i = 0; i < chansList.length; i++) {
                        ...
                        m3uStr += 'group-title=\"Harshit Rathi ' + (chansList[i].group_title) + '\", tvg-logo=\"https://mediaready.videoready.tv/tatasky-epg/image/fetch/f_auto,fl_lossy,q_auto,h_250,w_250/' + (chansList[i].tvg_logo) + '\", ' + chansList[i].name + '\n';
